...
The historical implementation remains ``combo_tf01_mr10_garch07_v1.py``. This
module gives the archive branch a versioned Team01 strategy id that matches the
V2/V3 summary-branch naming convention.
"""

from strategies.combo_tf01_mr10_garch07_v1 import ComboTF01MR10Garch07V1 as _ComboV1
