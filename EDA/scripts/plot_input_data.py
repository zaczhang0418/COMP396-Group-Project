...
def plot_price_data(data_path=".", output_dir=None, normalise=False, selected_series=None):
    ...
    #   1) stage_4_input_data_prices.png
    #   2) stage_4_input_data_prices_normalised.png
    #
    # Parameters:
    ...
    if output_dir is None:
        ...
        output_dir = str(chart_dir(dataset_name, "input_data"))
    ...
    raw_path = os.path.join(output_dir, "stage_4_input_data_prices.png")
    ...
    if normalise:
        ...
        norm_path = os.path.join(output_dir, "stage_4_input_data_prices_normalised.png")
