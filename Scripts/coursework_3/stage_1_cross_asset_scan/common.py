...
from Scripts.path_utils.common_paths import PART_DATA_DIRS, load_timeline, rel_path  # noqa: E402


DEFAULT_SCAN_TAG = "coursework_3/stage_1_cross_asset_scan"
...
STRATEGY_CONFIG = {
    "tf": {
        ...
        "grid_config": PROJ / "Configs" / "grids_for_single_strategies" / "tf" / "refined" / "refined_v1.json",
        "grid_search_runner": PROJ / "Scripts" / "coursework_2" / "stage_2_single_strategy_optimization" / "tf" / "run_grid_search.py",
        "run_once_runner": PROJ / "Scripts" / "coursework_2" / "stage_2_single_strategy_optimization" / "tf" / "run_once.py",
    },
    "mr": {
        "strategy_id": "mr_generic_v1",
        "grid_config": PROJ / "Configs" / "grids_for_single_strategies" / "mr" / "refined" / "refined_v1.json",
        "grid_search_runner": PROJ / "Scripts" / "coursework_2" / "stage_2_single_strategy_optimization" / "mr" / "run_grid_search.py",
        "run_once_runner": PROJ / "Scripts" / "coursework_2" / "stage_2_single_strategy_optimization" / "mr" / "run_once.py",
    },
    "garch": {
        "strategy_id": "garch_generic_v1",
        "grid_config": PROJ / "Configs" / "grids_for_single_strategies" / "garch" / "refined" / "refined_v1.json",
        "grid_search_runner": PROJ / "Scripts" / "coursework_2" / "stage_2_single_strategy_optimization" / "garch" / "run_grid_search.py",
        "run_once_runner": PROJ / "Scripts" / "coursework_2" / "stage_2_single_strategy_optimization" / "garch" / "run_once.py",
    },
}
