...
OUT_DIR = ROOT / "Output" / "coursework_3" / "stage_3_chapter3_evidence" / "part3_drawdown_analysis"
...
def _load_v2_strategy_class():
    return load_strategy_class("coursework_2.stage_3_team01_v2_presubmission", "TeamStrategy")
