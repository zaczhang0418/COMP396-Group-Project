# -*- coding: utf-8 -*-
#!/usr/bin/env python3
# Scripts/coursework_2/stage_2_single_strategy_optimization/garch/run_grid_search.py
import argparse
import itertools
import json
import subprocess
...
DEFAULT_GRID_CONFIG = PROJ / "Configs" / "grids_for_single_strategies" / "garch" / "refined" / "refined_v1.json"
DEFAULT_EXPERIMENT_TAG = "adhoc"

STRATEGY = "coursework_2.stage_2_garch_generic_v2"
DATA_NAME = "series_7"
ASSET_TAG = "asset07"
...
if __name__ == "__main__":
    ...
    out_root = Path(args.output_root) if args.output_root else get_coursework_2_stage2_dir(args.experiment_tag, "part1", "garch", "grid_search")
