# -*- coding: utf-8 -*-
#!/usr/bin/env python3
# Scripts/coursework_2/stage_2_single_strategy_optimization/garch/pick_best.py
import argparse
import json
import subprocess
import sys
...
RUN_ONCE = PROJ / "Scripts" / "coursework_2" / "stage_2_single_strategy_optimization" / "garch" / "run_once.py"
