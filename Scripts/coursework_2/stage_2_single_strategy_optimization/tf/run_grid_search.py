# -*- coding: utf-8 -*-
#!/usr/bin/env python3
# Scripts/coursework_2/stage_2_single_strategy_optimization/tf/run_grid_search.py
import argparse
import itertools
import json
import subprocess
...
def write_meta(
    ...
    meta = {
        ...
        "data_name": data_name,
        "split": "IS(70%)",
        "fromdate": splits["is"]["start"],
        "todate": splits["is"]["end"],
...
if __name__ == "__main__":
    ...
    out_root = Path(args.output_root) if args.output_root else get_coursework_2_stage2_dir(args.experiment_tag, "part1", "tf", "grid_search")
