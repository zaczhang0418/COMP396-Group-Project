#!/usr/bin/env python3
"""Run Coursework 1 V1 strategies across PART1, PART2, PART3, and PART123."""
...
OUTPUT_ROOT = PROJECT_ROOT / "output" / "coursework_1_stage5_v1_archive"
...
STRATEGIES = [
    ...
    },
    {
        ...
        "strategy": "combo_tf01_mr10_garch07_v1",
        "params": [],
    },
]
...
def write_outputs(rows: list[dict], commands: list[list[str]]) -> None:
    ...
    manifest = {
        "branch_purpose": "Coursework 1 Stage 5 V1 archive matrix",
