...
DEFAULT_GRID_CONFIG = PROJ / "configs" / "grids" / "tf_refined_v1.json"
...
def write_meta(run_dir: Path, search_params: dict, fixed_params: dict, grid_config: Path, splits: dict):
    meta = {
...
def run_one(search_params: dict, fixed_params: dict, run_dir: Path, timeline: dict, grid_config: Path) -> dict:
