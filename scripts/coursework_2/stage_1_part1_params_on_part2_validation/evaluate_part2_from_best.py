...
from scripts.path_utils.common_paths import (  # noqa: E402
    PART_DATA_DIRS,
    STRATEGY_LAYOUT,
    part_root,
    get_stage_dir,
...
RUNNERS = {
    "tf": PROJ / "scripts" / "coursework_2" / "stage_2_single_strategy_optimization" / "tf" / "run_once.py",
    "mr": PROJ / "scripts" / "coursework_2" / "stage_2_single_strategy_optimization" / "mr" / "run_once.py",
    "garch": PROJ / "scripts" / "coursework_2" / "stage_2_single_strategy_optimization" / "garch" / "run_once.py",
}
COMBO_RUNNER = PROJ / "scripts" / "coursework_1" / "stage_4_run_combo_once.py"
