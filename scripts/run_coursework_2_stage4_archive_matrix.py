#!/usr/bin/env python3
"""Summarize normalized Coursework 2 V2 archive evidence.

This script reads only output/coursework_2_stage4_v2_archive. It does not rely
...
DEFAULT_OUTPUT_ROOT = PROJECT_ROOT / "output" / "coursework_2_stage4_v2_archive"
...
def write_outputs(output_root: Path, rows: list[dict], leg_rows: list[dict]) -> None:
    ...
    manifest = {
        "branch_purpose": "Coursework 2 Stage 4 V2 full optimization archive summary",
